...
parser.add_argument(
    "--epoch_step", default=[30, 40], type=int, nargs="+", help="number of epochs to change learning rate"
)
# parser.add_argument('--device_ids', default=[0], type=int, nargs='+', help='number of epochs to change learning rate')
parser.add_argument("-b", "--batch-size", default=16, type=int)
parser.add_argument(
    "-j", "--num_workers", default=8, type=int, metavar="INT", help="number of data loading workers (default: 4)"
)
